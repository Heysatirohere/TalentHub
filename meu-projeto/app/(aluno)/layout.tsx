      ...
      <header className="npa-nav sticky top-0 z-40 backdrop-blur-xl border-b" style={{ borderColor: "var(--border-light)" }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2.5">
            {currentAluno?.nome && (
              <span className="hidden sm:flex items-center gap-1.5 text-xs font-semibold text-white/80 px-2.5 py-1 rounded-full bg-white/5 border border-white/10">
